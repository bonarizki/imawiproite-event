...
(function($){
    ...
    $.jSlots = function(el, options){
        ...
        $.jSlots.defaultOptions = {
            number : 8,          // Number: number of slots
        ...
        base.randomRange = function(low, high) {
            let data = base.options.arrayWinner
            if(data.length > 0){
                let indexarr = data[0];
                if(indexarr == 0){
                    indexarr = 10;
        ...
        base.Slot.prototype = {
            ...
            lowerSpeed : function() {
                ...
                if ( this.loopCount < base.options.loops ) {
                    // console.log('.'+base.options.loops)
                    this.spinEm();
        ...
        base.playSlots = function() {
            ...
            //     base.allSlots,function(index, val) {
            //         this.spinSpeed = 0;
            //         this.loopCount = 0;
            //         this.spinEm();
            //     }
