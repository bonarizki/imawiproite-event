...
<section id="basic-horizontal-layouts" class="body-batch">
    ...
    <div class="row mt-2 mb-2">
        <div class="col-4"></div>
        <div class="col-4 d-flex justify-content-center">
            <img src="{{asset('images/doorprize/Nano Blue Light Atomizer.jfif')}}" alt="Nano Blue Light Atomizer" width="200px" height="200px" class="image shadow">
        </div>
        <div class="col-4"></div>
    </div>
    <div class="row mt-2 mb-2">
        ...
        <div class="col-4 d-flex justify-content-center">
           <h1>Nano Blue Light Atomizer/ 45 pcs</h1>
        </div>
        <div class="col-4"></div>
    </div>
    <div class="row" id="row-button" >
        <div class="col">
            <button type="button" class="btn btn-success btn-lg btn-block shadow-bottom" id="spin" onclick="spin()">START SPIN <i>(0/5)</i></button>
        </div>
    </div>
    <div class="row mt-2 mb-2">
        <div class="col-4 d-flex justify-content-center">
