...
<section id="basic-horizontal-layouts" class="body-batch">
    ...
    {{-- <div class="row mt-2 mb-2">
        <div class="col-4"></div>
        <div class="col-4 d-flex justify-content-center">
            <img src="{{asset('images/doorprize/Hand Sanitizer Automatic Dispenser.jfif')}}" alt="" width="200px" height="200px" class="image shadow">
        </div>
        <div class="col-4"></div>
    </div> --}}
    <div class="row mt-2 mb-2">
